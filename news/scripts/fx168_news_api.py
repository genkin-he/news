...
class FX168NewsAPI:
    ...
    def get_json_by_url(self, url, params={}, pcc_value=None):
        if pcc_value:
            ...
            default_pcc = "YME+yJylGxGeXNepYvfDJDW0jV7w55ZfPJyk79q5x506iFpVIdts8S/OZ3am6mhsA1m0orbe9QAMEU4GGrpFqPb3oq4ZOaVmQGSFV8ZeEZPoWUnWLp8afTwT+XGDe8yScg68sXDLIuTDdjog98M2Qy9zkxV0bzD1VysYhzIVFwg="
