...
class FX168NewsAPI:
    ...
    def get_json_by_url(self, url, params={}, pcc_value=None):
        if pcc_value:
            ...
            default_pcc = "EGt7HncAgASNKmuaL8tTg+hW/Hd/Xt5QZjpEkq7OvcOaFZAqWPzXwnsH/GzjF8j5EClsXm57Q0CpRRw5x15r5sDrIirwTNx3qazB7GZL2wz6gIa+Z2pDY4oppp76PKGaD91/nnI/bToQjPhWWAKEoZHh9Dz8mu2QKNl9ukD2vuk="
