...
class FX168NewsAPI:
    ...
    def get_json_by_url(self, url, params={}, pcc_value=None):
        if pcc_value:
            ...
            default_pcc = "Bl8DF9ST+A8XKuhJ0Blhz/CNe2rkVvnGqHRPn/SshlQseLLQY2oQGAuq3j449tKkQ3NG9ds1t99dWXiLi2SLyeyHKYo5B70mVwyOON6wqKBicjLVovWOMZjrtFalQVNJQCHSn1DWptVTZBeUG4AkN1VtVrxZqTYAAZ9QzmohGXo="
