...
class FX168NewsAPI:
    ...
    def get_json_by_url(self, url, params={}, pcc_value=None):
        if pcc_value:
            ...
            default_pcc = "YDtEDi3WprkRh+pA7mrWcoYTilkYEXWWbQcNIaXs60E8bzuvkLPIWeou/czJ+Ke+sTIchoJu2Zglw8roPP35eYORIEy29aVxNBDDYKvWNfRSHgZ8hRRJybxEDax3u9rHdvMr9fdXZjD0a+PZG/i2ro36O2AGo28yX8B/aYTzEj0="
