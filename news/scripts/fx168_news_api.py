...
class FX168NewsAPI:
    ...
    def get_json_by_url(self, url, params={}, pcc_value=None):
        if pcc_value:
            ...
            default_pcc = "cj2AmeaSRK7vLxVeICRJJNtBA1+j5FCgmog/I8gAc6WBetom81c1aCgiZEBBMM1vjWfmhavXBqzASDDmDndnvxOzUeljhyrbVJoDrAomRmxhRvlOdNEm9STlBLvfXUrvJf/t5jVxiNF9mknr4o8JVVXLiJ9OJEVcl74mhMBV8Kc="
