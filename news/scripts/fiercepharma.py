...
def get_detail(link):
    ...
    if response.status == 200:
        ...
        print("fiercepharma request: {} error: ".format(link), response)
        return ""
    ...
    if response.status == 200:
        ...
        for index in range(len(items)):
            ...
            if link in ",".join(_links):
                print("fiercepharma exists link: ", link)
                break
        ...
        util.log_action_error("fiercepharma request error: {}".format(response))
