...
if __name__ == "__main__":
    # 数据源已消失，停止采集：
    #   reporterosdelsur.com / www.reporterosdelsur.com 的 A 记录为 NXDOMAIN（域名已注销）；
    #   脚本实际抓取的列表源 lisboatv.pt 现 302 至 coletivometranca.com.br 并返回 404。
    # 保留一条 pass 使 if 块非空，并已移除文件可执行位，CI 的 find -perm -u=x 不会再选中。
    pass
