...
if __name__ == "__main__":
    # 停止采集：站点的 CDN（CNAME tongbicapital.com.a1.initzz.com）无任何海外节点，
    # 各地区 ECS 解析结果全为中国大陆 IP，CI 的美国 runner 只能连到仅服务国内的边缘节点，
    # 固定返回 403（响应体为该 CDN 的 403 页，非质询、非签名）。需中国大陆出口方可访问，
    # 代码层面无解。
    # 保留一条 pass 使 if 块非空——本仓库 news.yml 执行前会 chmod +x 所有脚本，
