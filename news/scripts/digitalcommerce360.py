...
# 实测真实正文的 <p> 直接挂在 div.content 下、没有包装 div，故剥 div 安全；
# 另有 <center> 与 div.ad 承载广告位，以及文末 a.simplefavorite-button 收藏按钮，一并剥掉。
STRIP_SELECTOR = "figure,div,center,script,style,iframe,noscript,a.simplefavorite-button"
# 兜底路径不剥 div（应对「正文整体嵌在 div 内」的结构，该情形已在
# worldpharmaceuticals 上把正文清成 0、rollingout 上个别文章亦如此），
# 但 center 与 div.ad 这类明确的广告容器仍需剥离
STRIP_SELECTOR_SAFE = (
    "figure,center,div.ad,script,style,iframe,noscript,a.simplefavorite-button"
)
