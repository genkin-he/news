...
def get_detail(link):
    ...
    if response.status == 200:
        ...
        print("cabotwealth request: {} error: ".format(link), response)
        return ""
    ...
    if response.status == 200:
        ...
        for node in nodes:
            ...
            if link in ",".join(links):
                print("cabotwealth exists link: ", link)
                break
        ...
        print("cabotwealth request error: ", response)
